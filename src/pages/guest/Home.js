      ...
      <div className="bg-white w-full xs:mt-1 xs:mb-4 mt-6  mb-10">
        <div className="flex flex-wrap justify-evenly">
          <div className="flex flex-col items-center w-full justify-center p-10">
            <Link className=" w-[33%] justify-center items-center" to="/donate">
              {" "}
              <button
                onClick={onMovingDonation}
                className="bg-green-600 flex flex-row w-full h-full justify-center mb-6  hover:bg-green-700 hover:shadow-lg
          focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 rounded"
              >
                <h1 className=" rtl-grid mt-4 text-8xl lg:text-4x md:text-4x sm:text-3xl xs:text-2xl font-bold text-white">
                  לחצו כאן לתרומה!
                </h1>
              </button>
            </Link>
            <div className="flex flex-row w-full justify-center ">
              <h1 className="flex justify-center w-full mt-3">
